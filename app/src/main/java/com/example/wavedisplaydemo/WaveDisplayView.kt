...
class WaveDisplayView @JvmOverloads constructor(
    ...
    private var clipOpretion=CLIP_RIGHT
    ...
    init {
        ...
        dragReboundAnimator.addUpdateListener {
            currentX = if (clipOpretion == CLIP_RIGHT) {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mwidth = w.toFloat()
        mheight = h.toFloat()
        currentX = if (clipOpretion == CLIP_RIGHT) mwidth - dragWidth else dragWidth
